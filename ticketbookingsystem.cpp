...
void menu()
{
        ...
        cout<<"\n\n\t\t\t\t <1> Movie Timings";
        cout<<"\n\t\t\t\t <2> Contact Us";
        cout<<"\n\t\t\t\t <3> DebitCard/CreditCard Registration";
        cout<<"\n\t\t\t\t <4> Exit \n\n";
...
//Function Declaration for DebitCard or Credit Card
void card()
{
    int cardid;
...
void pay(int a)
{
    ...
    cout<<"Your Booking is completed!! Thanks for choosing us!!"<<endl;
}